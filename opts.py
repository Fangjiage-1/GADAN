...
def get_args_parser():
    ...
    parser.add_argument('--batch_size', default=1, type=int,
                        help='per-process batch size (not reported in the paper)')
    ...
    parser.add_argument('--tokenizer_path', type=str, default='roberta-base',
                        help="Path to the tokenizer weights (local path or huggingface model name)")
    parser.add_argument('--text_encoder_path', type=str, default='roberta-base',
    ...
    parser.add_argument('--max_size', default=640, type=int,
                        help='fixed image size used by the RSVG pipeline')
