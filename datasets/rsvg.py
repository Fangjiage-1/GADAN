...
class RSVGDataset(data.Dataset):
    def __init__(self, images_path, anno_path, split_file=None, imsize=640, transform= None, augment= False,
...
def make_coco_transforms(image_set, cautious):
    ...
    # Paper configuration: every training image is resized to 640 x 640.
    image_size = (640, 640)
    if image_set == "train":
        return T.Compose(
            [T.Resize(image_size),
