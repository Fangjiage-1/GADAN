"""Evaluate a GADAN checkpoint with IoU-based grounding metrics."""
...
def get_bilstm_gsbi_parser():
    parser = argparse.ArgumentParser('Refer_RSVG GADAN inference script', parents=[opts.get_args_parser()])
